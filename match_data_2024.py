...
# and saves it to a JSON file named "nrl_data_2024.json" in the "./data" directory.
    ...
    for year in years:
        ...
        for round_nu in range(1, 26):  # Loop through 25 rounds
            try:
                ...
                year_json_data.append(match_json)  # Append fetched JSON to year's data list
        ...
        match_json_datas.append(year_data)  # Append year's data to the main list
